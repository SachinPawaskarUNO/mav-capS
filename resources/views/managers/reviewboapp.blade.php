                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <a href="{{url('loan_application','bo_upload_IC')}}">Self Identification</a><br>
                                            <a href="{{url('loan_application','bo_business_license')}}">Business License</a><br>
                                            <a href="{{url('loan_application','bo_entity_type')}}">Business Entity Type</a><br>
                                            <a href="{{url('loan_application','bo_CTOS')}}">CTOS Documents</a><br>
                                            <a href="{{url('loan_application','bo_audited_statements')}}">Audited Financial Statements</a><br>
                                            <a href="{{url('loan_application','bo_operating_statements')}}">Operating Bank Statements</a><br>
                                            <a href="{{url('loan_application','bo_tax_returns')}}">Tax Return Forms</a>
                                        </div>
