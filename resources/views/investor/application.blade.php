            ...
            <div class="tab-content">
                <div id="menu1" class="tab-pane fade active in">
                                ...
                                <div class="panel panel-default">
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-md-6">
                                                {!! Form::select('inv_gender', array(''=>'-- Please Select --','male' =>'Male','female' =>'Female'),'',
                                                ['class'=>'form-control', 'id'=>'inv_gender']) !!}
                                            </div>
                                        </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-6">
                                                            {!! Form::select('inv_country',$countries,'',
                                                ['class'=>'form-control', 'id'=>'inv_country']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('inv_phone_number', 'Phone Number', ['class'=>'col-md-4 control-label']) !!}
                                                        <div class="col-md-6">
                                                            {!! Form::text('inv_phone_number',null,['class'=>'form-control', 'id'=>'inv_phone_number']) !!}
                                                        </div>
                                                    </div>
                                                </div>
                                                    </div>
                    ...
                    <!-- Contact Information Section End -->
                                                        ...
                                                        <div class="container" style="padding-top: 25px">
                                                            <div class="row">
                                                                <div class="col-md-8 col-md-offset-2">
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading"><h3><b>Investor Self Identification</b></h3></div>
                                                                        <div class="panel-body">
                                                                            <form class="form-horizontal" id="inv_self_identification">
                                                                                <div class="form-group">
                                                                                    {!! Form::label('inv_identity', 'Investor Identity', ['class'=>'col-md-4 control-label']) !!}
                                                                                    <div class="col-md-6">
                                                                                        {!! Form::select('inv_identity', array(''=>'-- Please Select --','retail investor' =>'Retail Investor','sophisticated investor' =>'sophisticated investor','company'=>'Company','angel'=>'Angel'),'',
                                                                                        ['class'=>'form-control', 'id'=>'inv_identity']) !!}
                    ...
                    <ul class="list-unstyled list-inline pull-right">
                        <li><button type="button" class="btn btn-info next-step" id="inv_next_step1">Next<i class="fa fa-chevron-right"></i></button></li>
                    </ul>
                </div>
                ...
                <div id="menu2" class="tab-pane fade">
                            ...
                            <div class="container" style="padding-top: 25px">
                                <div class="row">
                                    <div class="col-md-8 col-md-offset-2">
                                        <div class="panel panel-default">
                                            <div class="panel-heading"><h3><b>Investor Profile</b></h3></div>
                                            <div class="panel-body">
                                                    <div class="form-group">
                                                        {!! Form::label('inv_income', 'Income (Annually)', ['class'=>'col-md-4 control-label']) !!}
                                                        <div class="col-md-6">
                                                            {!! Form::select('inv_income', array(''=>'-- Please Select --','below MYR30k' =>'below MYR30k','MYR30k – MYR60k' =>'MYR30k – MYR60k','MYR60k- MYR 120k'=>'MYR60k- MYR 120k','MYR120k – MYR240k'=>'MYR120k – MYR240k','Above MYR300k'=>'Above MYR300k'),'',
                                                            ['class'=>'form-control', 'id'=>'inv_income']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('inv_net_worth', 'Net Worth', ['class'=>'col-md-4 control-label']) !!}
                                                        <div class="col-md-6">
                                                            {!! Form::select('inv_net_worth', array(''=>'-- Please Select --','MYR3mm' =>'MYR3mm','Above MYR3mm' =>'Above MYR3mm'),'',
                                                            ['class'=>'form-control', 'id'=>'inv_net_worth']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                        {!! Form::label('inv_liquid_asset', 'Liquid Assests', ['class'=>'col-md-4 control-label']) !!}
                                                        <div class="col-md-6">
                                                            {!! Form::select('inv_liquid_asset', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                            ['class'=>'form-control', 'id'=>'inv_liquid_asset']) !!}
                                                        </div>
                                                    </div>
                                                    <div class="form-group">
                                                    ...
                                                    <div class="row">
                                                            ...
                                                            <div class="panel panel-default">
                                                                ...
                                                                <div class="panel-body">
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_risk_tolerance', array(''=>'--Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_risk_tolerance']) !!}
                                                                            </div>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_stock_market', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_stock_market']) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            {!! Form::label('inv_bonds_notes', 'Bonds and Notes', ['class'=>'col-md-4 control-label']) !!}
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_bonds_notes', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_bonds_notes']) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            {!! Form::label('inv_mutual_funds', 'Mutual Funds', ['class'=>'col-md-4 control-label']) !!}
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_mutual_funds', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_mutual_funds']) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            {!! Form::label('inv_sme_business', 'SME Business', ['class'=>'col-md-4 control-label']) !!}
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_sme_business', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_sme_business']) !!}
                                                                            </div>
                                                                        </div>
                                                                        <div class="form-group">
                                                                            {!! Form::label('inv_p2p_lending', 'P2P Lending', ['class'=>'col-md-4 control-label']) !!}
                                                                            <div class="col-md-6">
                                                                                {!! Form::select('inv_p2p_lending', array(''=>'-- Please Select --','yes' =>'Yes','no' =>'No'),'',
                                                                                ['class'=>'form-control', 'id'=>'inv_p2p_lending']) !!}
                                                                            </div>
                                                                        </div>
</div>
                                                                    </div>
                                                        ...
                                                        <div class="container" style="padding-top: 25px">
                                                            <div class="row">
                                                                <div class="col-md-8 col-md-offset-2">
                                                                    <div class="panel panel-default">
                                                                        <div class="panel-heading"><h3><b>Financial Documentation</b></h3></div>
                                                                        <div class="panel-body">
                                                                            <div class="form-group">
                                    ...
                                    <ul class="list-unstyled list-inline pull-right">
                        <li><button type="button" class="btn btn-default prev-step" id="inv_prev_step_2"><i class="fa fa-chevron-left"></i> Back</button></li>
                        <li><button type="button" class="btn btn-info next-step" id="inv_next_step2">Submit <i class="fa fa-chevron-right"></i></button></li>
                    </ul>
</div>
        </div>
                                                {!! Form::close() !!}
