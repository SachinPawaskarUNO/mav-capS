...
public class Bo_status_apply2 {
	...
	public void borrower_status() throws InterruptedException
	{
		...
		//Thread.sleep(2000);
		driver.findElement(By.xpath(".//*[@id='email']")).sendKeys("nareshpasupuleti@yahoo.com");
		...
		driver.findElement(By.xpath(".//*[@id='bo_first_name']")).sendKeys("Naresh");
		driver.findElement(By.xpath(".//*[@id='bo_last_name']")).sendKeys("Pasupuleti");
