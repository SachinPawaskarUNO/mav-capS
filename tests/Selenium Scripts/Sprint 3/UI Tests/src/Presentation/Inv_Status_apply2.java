...
public class Inv_Status_apply2 {
	...
	public void investor_status() throws InterruptedException
	{
		...
		driver.findElement(By.xpath(".//*[@id='inv_first_name']")).sendKeys("Ravi");
		driver.findElement(By.xpath(".//*[@id='inv_last_name']")).sendKeys("Singhania");
		...
		driver.findElement(By.xpath(".//*[@id='inv_phonenumber']")).sendKeys("9876541516");
		...
		driver.findElement(By.xpath(".//*[@id='inv_estimated_p2p']")).sendKeys("4321");
		...
		dropdown7.click();
		example_dd7.selectByVisibleText("No");
		...
		dropdown9.click();
		example_dd9.selectByVisibleText("No");
		...
		dropdown11.click();
		example_dd11.selectByVisibleText("No");
		
		Thread.sleep(3000);
		

		driver.findElement(By.xpath(".//*[@id='inv_income_slip']")).sendKeys("/Users/npasupuleti/Documents/Attachments/income_slip.png");
		
		driver.findElement(By.xpath(".//*[@id='inv_bank_statements']")).sendKeys("/Users/npasupuleti/Documents/Attachments/Bank_statement.png");
		
		driver.findElement(By.xpath(".//*[@id='inv_financial_statements']")).sendKeys("/Users/npasupuleti/Documents/Attachments/finance_statement.png");
