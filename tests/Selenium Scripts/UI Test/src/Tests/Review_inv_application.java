...
public class Review_inv_application {
	static WebDriver driver = BaseTestCase.getDrivers();
/*
	@Test
	public static void Review_Inv_ButtonTest() throws InterruptedException {
		ManagerLogin ManagerLogin = new ManagerLogin();
		ManagerLogin.ManagerLoginTest(driver);
		driver.findElement(By.xpath(".//*[@id='manager_revinvapp_button']")).click();
		String Actual = "http://capsphere.herokuapp.com/review_inv_app";
	...
	public static void ViewDetailsButton() throws InterruptedException {
		driver.findElement(By.xpath(".//a[@href='http://capsphere.herokuapp.com/inv_application/5']")).click();
		String Actual = "http://capsphere.herokuapp.com/inv_application/5";
		String Expected = driver.getCurrentUrl();
		Assert.assertEquals(Actual, Expected);
	...
	public static void ViewDetailsBackButton() throws InterruptedException {
		driver.findElement(By.xpath(".//*[@id='inv_show_back']']")).click();
		String Actual = "http://capsphere.herokuapp.com/review_inv_app";
		String Expected = driver.getCurrentUrl();
		Assert.assertEquals(Actual, Expected);
	...
	public static void DownloadButton() throws InterruptedException {
		...
		driver.findElement(By.xpath(".//*[@id='inv_download']/div/div/div[2]/a[1]")).click();
	...
	public static void ApproveNoButton() throws InterruptedException {
		Thread.sleep(2000);
		driver.findElement(By.xpath(".//*[@id='app']/div/div/div/div[1]/table/tbody/tr[1]/td[2]/button[1]")).click();
		driver.findElement(By.xpath(".//*[@id='review_invapp_no']]")).click();
	}
	...
	public static void Acc_rej_view_details() throws InterruptedException {
		...
		String Actual = "http://capsphere.herokuapp.com/inv_application/1";
		String Expected = driver.getCurrentUrl();
		Assert.assertEquals(Actual, Expected);
	}
