...
public class VerifyFunds_LoanPayment_AcceptedRejected {
	...
	public static void AmountVerifiedTest() throws InterruptedException {

		String Actual = driver.findElement(By.xpath(".//*[@id='lrc2']/thead/tr/th[4]")).getText();
		String Expected = "Amount Verified";
		Assert.assertEquals(Actual, Expected);

	}

	@Test(dependsOnMethods = { "AmountVerifiedTest" }, alwaysRun = true)
