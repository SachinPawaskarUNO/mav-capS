...
public class ApplyLoan_loanDuration {
	static WebDriver driver = BaseTestCase.getDrivers();

	@Test
	public static void LoanDurationValidation() throws InterruptedException {
		...
		driver.findElement(By.xpath(".//*[@id='loan_duration']")).sendKeys("Test");
		driver.findElement(By.xpath(".//*[@id='loan_submit_button']")).click();
		Thread.sleep(2000);
		driver.findElement(By.xpath(".//*[@id='save_loan']")).click();
		String Expected = driver.findElement(By.xpath(".//*[@id='loan_application']/div[3]/div/span/strong")).getText();
		String Actual = "The loan duration field is required.";
