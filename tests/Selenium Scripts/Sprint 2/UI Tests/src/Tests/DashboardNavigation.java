...
public class DashboardNavigation {
	...
	public void VerifyInvestTC() throws InterruptedException
	{
	...
	public void VerifyBusinessLoansTC() throws InterruptedException
	{
		driver = Utilities.getDrivers();
		Utilities.getURL(driver);
	...
	public void VerifyHowItWorksTC() throws InterruptedException
	{
		driver = Utilities.getDrivers();
		Utilities.getURL(driver);
	...
	public void VerifyAboutUsTC() throws InterruptedException
	{
		driver = Utilities.getDrivers();
		Utilities.getURL(driver);
	...
	public void VerifyLoginTC() throws InterruptedException
	{
		driver = Utilities.getDrivers();
		Utilities.getURL(driver);
	...
	public void VerifyRegisterTC() throws InterruptedException
	{
		driver = Utilities.getDrivers();
		Utilities.getURL(driver);
