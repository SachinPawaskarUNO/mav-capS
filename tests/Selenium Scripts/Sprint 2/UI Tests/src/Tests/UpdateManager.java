...
public class UpdateManager {
	...
	public void UpdateManagerTC() throws InterruptedException
	{
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(".//a[@href='http://capsphere.herokuapp.com/managers/10/edit']")).click();
		...
		Thread.sleep(2000);
		driver.findElement(By.xpath(".//*[@id='app']/div/form/div[5]/button[1]")).click();
		Thread.sleep(3000);
		//.//*[@id='update_manager_confirm']
